...
for required in \
    ...
    "$RUNTIME_DIR/res/md-brick-mask.png"; do
    if [ ! -f "$required" ]; then
...
ssh "$DEVICE_HOST" "mkdir -p \
    ...
    '$REMOTE_STAGE/paks/Emus/GBA.pak' '$REMOTE_STAGE/paks/Emus/SFC.pak' '$REMOTE_STAGE/paks/Emus/MD.pak' \
    '$REMOTE_SYSTEM/bin' '$REMOTE_SYSTEM/cores' '$REMOTE_RES' \
    '$REMOTE_SYSTEM/paks/Emus/GB.pak' '$REMOTE_SYSTEM/paks/Emus/GBC.pak' \
    '$REMOTE_SYSTEM/paks/Emus/GBA.pak' '$REMOTE_SYSTEM/paks/Emus/SFC.pak' '$REMOTE_SYSTEM/paks/Emus/MD.pak' \
    /mnt/SDCARD/Roms/GB /mnt/SDCARD/Roms/GBC /mnt/SDCARD/Roms/GBA /mnt/SDCARD/Roms/SFC /mnt/SDCARD/Roms/MD \
    /mnt/SDCARD/Saves/GB /mnt/SDCARD/Saves/GBC /mnt/SDCARD/Saves/GBA /mnt/SDCARD/Saves/SFC /mnt/SDCARD/Saves/MD"
...
for system in GB GBC GBA SFC MD; do
...
echo "GB/GBC/GBA/SFC/MD runtime installed on $DEVICE_HOST"
